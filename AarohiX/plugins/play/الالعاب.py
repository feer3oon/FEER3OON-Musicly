...
GAME_MESSAGE = "𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝚁 . 𝚇\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب سورس مستر اكس\n\nᯓ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝚁 . 𝚇 "
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('الالعــاب-3D', callback_data= '𝙼𝚁 . 𝚇'),
        InlineKeyboardButton ('الالعــاب', callback_data= '𝙼𝚁 . 𝚇'),
        ],[
        InlineKeyboardButton ('𝚂𝙾𝚄𝚁𝙲𝙴 𝙼𝚁 . 𝚇', url =f"https://t.me/zzxxue")              
                 ],[
...
async def callback_query(client, CallbackQuery):
        ...
        InlineKeyboardButton ('ᯓ 𝚂𝙾𝚞𝚁𝚂 𝙼𝚁 . 𝚇 𓃠', url =f"https://t.me/zzxxue")              
                 ],[
                InlineKeyboardButton(
                        "◁", callback_data="close"),
               ],
               ...
               SOURCE_GAME = "𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗥 . 𝗫 𓃠\n\n★¦العاب \n★¦كت\n★¦تويت\n★¦اسال\n★¦اصراحه\n★¦ لو خيروك \n★¦كتابات \n★¦زوجني \n★¦التسليه \n★¦صور\n★¦انصحني\n★¦نداء\n★¦حروف\n★¦غنيلي\n\n⩹━⊷⌯⌞  𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗥 . 𝗫 ⌝⌯⊶━⩺." 

               SORGAM_BUTTON = [
                    [ 
                      InlineKeyboardButton ('𝗦𝗼𝘂𝗿𝗰𝗲 𝗠𝗥 . 𝗫 𓃠', url =f"https://t.me/zzxxue ")
                      ],[
